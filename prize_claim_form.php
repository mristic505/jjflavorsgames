	...
	<form id="prize_form" action="prize_claim_form.php" method="POST">
		...
		<div class="form-group-holder clearfix">
			<div id="email-group" class="form-group col-sm-6">
				...
				<input type="email" class="form-control-noboot" name="email" placeholder="">
			</div>
			<div id="email-conf-group" class="form-group col-sm-6">
				<label>Confirm Email Address</label><br>
				<input type="email" class="form-control-noboot" name="email_conf" placeholder="">
			</div>
		</div>
		<div class="form-group-holder clearfix">
		...
		<div class="form-group-holder clearfix">
			...
			<div id="state-group" class="form-group col-sm-6">
				<div id="state" class="form-group col-sm-6">
				...
				<div id="-group" class="form-group col-sm-6">
					<label>Zip Code</label>
					<input type="text" class="form-control-noboot" name="" placeholder="">
				</div>
			</div>
		</div>
		<div class="form-group-holder clearfix">
		...
		<div class="form-group" id="">
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-default big_checkbox active">
                    <input type="checkbox" autocomplete="off" name="optin" id="optin" checked="checked">
